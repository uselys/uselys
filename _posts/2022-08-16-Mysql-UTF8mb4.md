...
```
ALTER TABLE mybb_posts CHANGE subject subject varchar(120) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
ALTER TABLE mybb_posts CHANGE username username varchar(80) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
ALTER TABLE mybb_posts CHANGE message message text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
ALTER TABLE mybb_posts CHANGE editreason editreason varchar(150) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;

ALTER TABLE mybb_threads CHANGE subject subject varchar(120) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
ALTER TABLE mybb_threads CHANGE username username varchar(80) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
ALTER TABLE mybb_threads CHANGE lastposter lastposter varchar(120) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
ALTER TABLE mybb_threads CHANGE closed closed varchar(30) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
ALTER TABLE mybb_threads CHANGE notes notes text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
```
